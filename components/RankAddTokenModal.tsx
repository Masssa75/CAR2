...
export function RankAddTokenModal({ isOpen, onClose, onSuccess }: AddTokenModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white border border-gray-200 shadow-xl rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            {projectStatus && (
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Analysis Progress</span>
                ...
                <div className={`text-sm ${projectStatus.hasError ? 'text-red-400' : 'text-gray-700'}`}>
            ...
            {isAdmin && submittedProject && (
              <div className="bg-gray-800/50 rounded p-2 text-xs space-y-1">
                <div className="text-gray-500 font-mono">Database Fields:</div>
            ...
            <div className="flex gap-3 pt-4">
              {projectStatus?.isComplete ? (
                <button
                  ...
                  className="flex-1 py-2 px-4 rounded-lg font-medium bg-emerald-500 text-white hover:bg-[#00cc66] transition-colors"
                >
                  View Project
                </button>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg max-h-60 overflow-y-auto">
                  {searchResults.map((coin) => (
                    <button
                      ...
                      className="w-full px-3 py-3 flex items-center gap-3 hover:bg-gray-100 transition-colors border-b border-gray-200 last:border-b-0"
                      disabled={isSubmitting}
                    >
                      <img
                        src={coin.thumb}
              ...
              <div className="mt-3 p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-500 font-mono text-sm resize-y"
                    disabled={isSubmitting}
                  />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 px-4 rounded-lg font-medium bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-200 disabled:text-gray-500"
                      >
